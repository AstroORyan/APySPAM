class Parameters:
  ...
  def testCollision(self):
    ...
    # particle numbers
    self.n1 = 1000
    self.n2 = 500        #NOTE: This has been changed from 1000 (11/10/19)
  ...
  def customCollision(self):
    ...
    self.epsilon2 = 0.3
    self.eps2 = self.epsilon2*self.epsilon2
    self.n2 = 1000      #NOTE: Changed from 500
    self.heat2 = 0.0
    self.opt2 = 1

    self.inclination_degree = 60.0    #NOTE: Changed from 20
    self.omega_degree = 0.0
    self.rmin = 0.5                   #NOTE: Changed from 0.9
