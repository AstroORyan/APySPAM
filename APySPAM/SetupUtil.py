# -*- coding: utf-8 -*-
"""
Created on Tue Aug 31 17:04:09 2021
...
class SetupUtil:
  ...
  def customCollision(self):
    ...
    rx = 0.43431112#2.151963#-0.40793
    ry = -2.0819992#-0.478214#-1.92518
    rz = 1.0#1.95772
    vx = -1.14918
    vy = -1.02439
    vz = 0.77963
  ...
  def perturberPositionVec(self,xx0, mass1, mass2, eps1, eps2, h, n, n1, t0, x0):
    ...
    while( t0 < tcurrent ):
      ...
      self.params.Seperation.append(np.sqrt(tmpr))
  ...
  def rvToCoe(r,v,mu):
    ...
    # Safety for rounding error that sometimes happens in Python
    if cosw > 1.0:
        cosw = 1.0
    elif cosw < -1.0:
        cosw = -1.0
